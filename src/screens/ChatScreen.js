...
export default function ChatScreen({ route, navigation }) {
  ...
  // Define o Wrapper: KeyboardAvoidingView para iOS e Android
    ...
    <View style={styles.container}>
      ...
      <Wrapper {...wrapperProps}>
        <FlatList
          ...
          // Garante que a lista se comporte bem ao redimensionar a tela no Android
...
const styles = StyleSheet.create({
  ...
  inputArea: { 
    ...
    alignItems: 'center',
    backgroundColor: '#000',
    // Importante: No Android não queremos margem extra para o teclado não empurrar demais
